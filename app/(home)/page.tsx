...
export async function generateMetadata() {
  ...
  return {
    title:
      "Landschaftshelden - Jetzt den passenden Garten- & Landschaftsbauer finden",
    description:
      "Finden Sie den besten Garten- & Landschaftsbauer in Ihrer Nähe mit Landschaftshelden. Einfach, schnell und zuverlässig!",
    openGraph: {
      title:
        "Landschaftshelden - Jetzt den passenden Garten- & Landschaftsbauer finden",
      description:
        "Finden Sie den besten Garten- & Landschaftsbauer in Ihrer Nähe mit JobSmith. Einfach, schnell und zuverlässig!",
        ...
        <div className='flex flex-col gap-24 my-32'>
          <div className='text-center'>
            <h3 className='font-bold text-3xl md:text-5xl mb-6'>
              Willkommen beim einfachsten Weg, Garten- & Landschaftsbauer zu
              finden
            </h3>
            ...
            <div className='flex flex-col gap-8 lg:w-1/2'>
              <div>
                ...
                <p className='text-base md:text-lg mt-2'>
                  Finden Sie Garten- & Landschaftsbauer in Ihrer Umgebung und
                  treten Sie direkt mit ihnen in Kontakt. Wählen Sie den
                  passenden Experten für Ihr Projekt und bringen Sie Ihre Ideen
                  zum Leben!
                </p>
              </div>
              <div>
                ...
                <p className='text-base md:text-lg mt-2'>
                  Sehen Sie sich Unternehmen aus Ihrer Region an und entscheiden
                  Sie selbst, wer der passende Handwerker für Ihr Projekt ist.
                </p>
              </div>
              <div className='text-center'>
