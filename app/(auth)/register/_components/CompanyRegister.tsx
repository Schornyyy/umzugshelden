...
const CompanyRegister: React.FC = () => {
  ...
  const onSubmit = async(submitData: CompanyFormData) => {
    const d:CompanyType = {...data!, city: submitData.city, zip: submitData.postalCode, companyName: submitData.companyName, companyNumber: submitData.companyNumber, companyEmail: submitData.companyEmail, companyWebsite: submitData.website};
    await fetchCoordinates(submitData.city, submitData.postalCode).then((res) => {
      if(res) {
