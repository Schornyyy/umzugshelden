...
const RegisterStep = () => {
  ...
  return (
    <div className='flex flex-col w-full justify-center items-center h-screen max-md:p-6'>
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6  w-full md:w-1/5 p-4 border rounded-md shadow">
      {/* Email */}
      ...
      <div className="flex flex-col">
        <label htmlFor="confirmPassword" className="font-semibold">Passwort wiederholen</label>
        <input
          type="password"
          id="confirmPassword"
      ...
      <div className='flex flex-row justify-between'>
        <button disabled={loading} className='py-2 px-4 rounded text-white bg-blue-600 disabled:bg-blue-400 hover:bg-blue-700' onClick={() => handleBack()}>
          Zurück
        </button>
      <button
      disabled={loading}
