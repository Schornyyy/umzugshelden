...
import { updatePartnerProfile } from "@/actions/partnerActions";
...
export function PartnerProfileEditor({
  ...
  const [data, setData] = useState<PartnerProfileData>(() => ({
    id: profile.id,
    email: profile.email,
  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between mb-2'>
        <h2 className='text-xl font-semibold'>Partnerseite</h2>
        ...
        <CardContent className='space-y-3'>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setData((d) => ({ ...d, contactPerson: e.target.value }))
              }
            />
          </div>
        </CardContent>
